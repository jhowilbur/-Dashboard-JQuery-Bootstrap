...
###### take advantage of the file created in recuperar.html and reuse it by changing the name to registro.html
###### changing some tags, such as title, card, remove text and div over email

![Screenshot_1](https://user-images.githubusercontent.com/59379254/83529877-53cfeb80-a4c1-11ea-81c5-2688761fe135.png)
![Screenshot_2](https://user-images.githubusercontent.com/59379254/83529878-54688200-a4c1-11ea-9d1e-448097f45c5c.png)
              ...
              <div class="form-group">
                  <div class="form-row">
                      <div class="col-md-6">
                          ...
                          name="primeiroNome" placeholder="Digite seu primeiro nome">
                      </div>
                      <div class="col-md-6">
                        <label for="segundoNome">Segundo Nome</label>
                        <input type="text" class="form-control" id="segundoNome"
                        name="segundoNome" placeholder="Digite seu sobrenome">
                    </div>
                  </div>
              </div>
              ...
              <div class="form-group">
                <div class="form-row">
                    ...
                    <div class="col-md-6">
                      ...
                      name="confirmaSenha" placeholder="Digite a senha novamente">
                  </div>
                </div>
                    <br>
